...
FILE_PATH = r"7EE Game Request - V4 (with Changes & Banner Summary) - Jan 20th-2025 (1).xlsx"
...
def main():
    ...
    # Page 1: Upload Excel File
    if st.session_state.page == "upload":
        st.title("Upload Store Data")
        uploaded_file = st.file_uploader("Upload an Excel file", type=["xlsx", "xls"])
        
        if uploaded_file:
            st.session_state.store_data = load_uploaded_data(uploaded_file)
